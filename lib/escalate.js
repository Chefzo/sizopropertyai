...
async function notifySienna({ escalationId, unitSlug, guestName, trigger, guestMessage, suggestedReply, conversationId, channel = 'hospitable', replyTo = null }) {
  const body =
  ...
  pending.set(process.env.SIENNA_PHONE, { escalationId, unitSlug, guestName, suggestedReply, conversationId, channel, replyTo });
